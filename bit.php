...

 {
...

	{
...

		{
			...
			$query = "update ihax set level = 11, timestamp = '".time()."' where username = '".$_SESSION['name']."'";										
...
<br>
 ...
 ERROR: torentz.txt file not found in this level.
 
<br><br>

Password : <input type = "password" name = "ans" value = ""></p>
</font>
