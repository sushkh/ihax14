...
if($_SESSION['level'] == "15")

		{
			...
			$query = "update ihax set level = 16, timestamp = '".time()."' where username = '".$_SESSION['name']."'";										
...
<font color="#dddddd" style="font-family: Arial, sans-serif;font-size: 15px;">
 <b> 
 <!-- 
 The previous key will unlock the other door.
 -->
 
 
<br>
<br>
The key to this door resides behind another door.
<br>
<br>
