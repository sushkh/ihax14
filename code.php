...
session_start();
...

 {
	...
	if(stristr($_POST['ans'],"adminpass"))
...
if($_SESSION['level'] == "19")

		{
			...
			$query = "update ihax set level = 20, timestamp = '".time()."' where username = '".$_SESSION['name']."'";										
...
<img src="images/code.png" width="450px" height="150px" style = "vertical-align:middle" /><br>
<br>
